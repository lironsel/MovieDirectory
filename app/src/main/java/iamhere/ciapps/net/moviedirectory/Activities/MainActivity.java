package iamhere.ciapps.net.moviedirectory.Activities;
...
import iamhere.ciapps.net.moviedirectory.Data.MovieRecyclerViewAdapter;
import iamhere.ciapps.net.moviedirectory.Model.Movie;
import iamhere.ciapps.net.moviedirectory.R;
import iamhere.ciapps.net.moviedirectory.Util.Constants;
import iamhere.ciapps.net.moviedirectory.Util.Prefs;
    ...
    public List <Movie> getMovies(String searchTerm) {
        ...
        try{
            ...
            for (int i=0; i<moviesArray.length(); i++){
                ...
                m.setType("Type: "+ movieObj.getString("Type"));
                m.setYear("Year Released: "+movieObj.getString("Year"));
                m.setPoster(movieObj.getString("Poster"));
                m.setImdbID(movieObj.getString("imdbID"));
